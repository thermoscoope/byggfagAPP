...
with tab_matte:
    ...
    if m_kat == "Omkrets":
        ...
        st.write("Omkretsen er summen av alle sidene.")
        ...
        st.write("Areal forteller hvor stor en flate er ($m^2$).")
        ...
        st.write("Volum forteller hvor mye en gjenstand rommer ($m^3$). Brukes for å beregne betong.")
        ...
        st.write("Hvis sidene er 3 og 4, må diagonalen være 5 for å sjekke 90 grader.")
